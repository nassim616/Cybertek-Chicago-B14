...
public class nestedLoopChecking {
    public static void main(String[] args) {

// 3) Ask user to enter their number (Take it as a String). A number can only be valid if it is 10 characters long or is 12 characters with the “(“ and “)” characters in the 1st or 5th characters. Then make sure the number provided contains only numbers and not any other characters.
